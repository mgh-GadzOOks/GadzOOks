...
Console.WriteLine("RESIZE WINDOW UNTIL GAZOOKS TITLE ASCII TEXT IS CLEARLY READABLE \nFOR OPTIMAL USER EXPERIENCE!");
...
");
    ...
    {
        case "s": mainMenuOpen = false;
            break;
        case "o": goToOptionsMenu = true;
            break;
        case "q":
            return;
        default: Console.WriteLine("Error with menu.");
           break;
    }
